...
const (
	...
	AnkrContractTransferName = "Transfer"
)
...
func newToken(name string, ethClient *ethclient.Client) (*Token, error) {
	var contractAddress, contractAbi string
	switch name {
	case "ANKR":
	...
	return &Token{name, bindContract}, nil
}

func (t *Token) transfer(opts *bind.TransactOpts, toAddress common.Address, value *big.Int) (*types.Transaction, error) {
