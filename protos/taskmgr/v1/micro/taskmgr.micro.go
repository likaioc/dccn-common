...
<<<<<<< HEAD:protos/taskmgr/v1/micro/taskmgr.micro.go
/*
...
*/
=======
>>>>>>> [SWDEV-122] readd stream definition for dc-mgr to dc-facade:protos/appmgr/v1/micro/taskmgr.micro.go
package appmgr
...
type AppMgrService interface {
	...
	AppLeaderBoard(ctx context.Context, in *common.Empty, opts ...client.CallOption) (*AppLeaderBoardResponse, error)
	CreateChart(ctx context.Context, in *CreateChartRequest, opts ...client.CallOption) (*common.Empty, error)
	...
	CreateNamespace(ctx context.Context, in *CreateNamespaceRequest, opts ...client.CallOption) (*common.Empty, error)
...
func (c *appMgrService) AppLeaderBoard(ctx context.Context, in *common.Empty, opts ...client.CallOption) (*AppLeaderBoardResponse, error) {
...
func (c *appMgrService) CreateChart(ctx context.Context, in *CreateChartRequest, opts ...client.CallOption) (*common.Empty, error) {
...
func (c *appMgrService) CreateNamespace(ctx context.Context, in *CreateNamespaceRequest, opts ...client.CallOption) (*common.Empty, error) {
...
func RegisterAppMgrHandler(s server.Server, hdlr AppMgrHandler, opts ...server.HandlerOption) error {
	type appMgr interface {
		...
		AppLeaderBoard(ctx context.Context, in *common.Empty, out *AppLeaderBoardResponse) error
		CreateChart(ctx context.Context, in *CreateChartRequest, out *common.Empty) error
		...
		CreateNamespace(ctx context.Context, in *CreateNamespaceRequest, out *common.Empty) error
...
func (h *appMgrHandler) AppLeaderBoard(ctx context.Context, in *common.Empty, out *AppLeaderBoardResponse) error {
	return h.AppMgrHandler.AppLeaderBoard(ctx, in, out)
}

func (h *appMgrHandler) CreateChart(ctx context.Context, in *CreateChartRequest, out *common.Empty) error {
...
func (h *appMgrHandler) CreateNamespace(ctx context.Context, in *CreateNamespaceRequest, out *common.Empty) error {
