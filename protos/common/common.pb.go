...
func (Operation) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_common_478021ebf5d7c188, []int{0}
}
...
func (TaskStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_common_478021ebf5d7c188, []int{1}
}
...
const (
	...
	TaskType_DeployTaskType  TaskType = 1
...
func (TaskType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_common_478021ebf5d7c188, []int{2}
}
...
func (Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_common_478021ebf5d7c188, []int{3}
}
...
func (*Event) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_478021ebf5d7c188, []int{4}
}
...
func (*MailEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_478021ebf5d7c188, []int{5}
}
...
func init() { proto.RegisterFile("common.proto", fileDescriptor_common_478021ebf5d7c188) }

var fileDescriptor_common_478021ebf5d7c188 = []byte{
	...
	,
}
