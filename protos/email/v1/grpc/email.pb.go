...
func (*MailEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_email_c1dcedcfc22c0272, []int{0}
}
...
func (*Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_email_c1dcedcfc22c0272, []int{1}
}
...
func init() {
	proto.RegisterType((*MailEvent)(nil), "grpc.mail.MailEvent")
	proto.RegisterType((*Response)(nil), "grpc.mail.Response")
}
...
func (c *mailClient) Send(ctx context.Context, in *MailEvent, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/grpc.mail.Mail/Send", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Mail_Send_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.mail.Mail/Send",
	}
...
func init() { proto.RegisterFile("email/v1/grpc/email.proto", fileDescriptor_email_c1dcedcfc22c0272) }

var fileDescriptor_email_c1dcedcfc22c0272 = []byte{
	...
	,
}
