...
type MailService interface {
	Send(ctx context.Context, in *MailEvent, opts ...client.CallOption) (*common.Empty, error)
}
...
func (c *mailService) Send(ctx context.Context, in *MailEvent, opts ...client.CallOption) (*common.Empty, error) {
...
func RegisterMailHandler(s server.Server, hdlr MailHandler, opts ...server.HandlerOption) error {
	type mail interface {
		Send(ctx context.Context, in *MailEvent, out *common.Empty) error
	}
	type Mail struct {
		mail
	}
...
func (h *mailHandler) Send(ctx context.Context, in *MailEvent, out *common.Empty) error {
