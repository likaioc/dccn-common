...
func (*DataCenterListResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_dcmgr_9fa712f85a845b8f, []int{0}
}
...
func (*NetworkInfoResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_dcmgr_9fa712f85a845b8f, []int{1}
}
...
func (*DataCenterLeaderBoardResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_dcmgr_9fa712f85a845b8f, []int{2}
}
...
func (*DataCenterLeaderBoardDetail) Descriptor() ([]byte, []int) {
	return fileDescriptor_dcmgr_9fa712f85a845b8f, []int{3}
}
...
func init() { proto.RegisterFile("gateway/dcmgr/v1/dcmgr.proto", fileDescriptor_dcmgr_9fa712f85a845b8f) }

var fileDescriptor_dcmgr_9fa712f85a845b8f = []byte{
