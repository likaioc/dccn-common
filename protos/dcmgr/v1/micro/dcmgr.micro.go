...
type DCService interface {
	...
	PurgeApp(ctx context.Context, in *common_proto1.AppID, opts ...client.CallOption) (*common_proto1.Empty, error)
...
func (c *dCService) PurgeApp(ctx context.Context, in *common_proto1.AppID, opts ...client.CallOption) (*common_proto1.Empty, error) {
...
type DCHandler interface {
	...
	PurgeApp(context.Context, *common_proto1.AppID, *common_proto1.Empty) error
...
func RegisterDCHandler(s server.Server, hdlr DCHandler, opts ...server.HandlerOption) error {
	type dC interface {
		...
		PurgeApp(ctx context.Context, in *common_proto1.AppID, out *common_proto1.Empty) error
...
func (h *dCHandler) PurgeApp(ctx context.Context, in *common_proto1.AppID, out *common_proto1.Empty) error {
