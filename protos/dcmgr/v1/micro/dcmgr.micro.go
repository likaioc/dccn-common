...
type DCService interface {
	...
	DeleteApp(ctx context.Context, in *common.AppDeployment, opts ...client.CallOption) (*common.Empty, error)
	CreateNamespace(ctx context.Context, in *common.Namespace, opts ...client.CallOption) (*common.Empty, error)
	UpdateNamespace(ctx context.Context, in *common.Namespace, opts ...client.CallOption) (*common.Empty, error)
	DeleteNamespace(ctx context.Context, in *common.Namespace, opts ...client.CallOption) (*common.Empty, error)
	InitDC(ctx context.Context, in *common.DataCenter, opts ...client.CallOption) (*common.Empty, error)
...
func (c *dCService) DeleteApp(ctx context.Context, in *common.AppDeployment, opts ...client.CallOption) (*common.Empty, error) {
...
func (c *dCService) CreateNamespace(ctx context.Context, in *common.Namespace, opts ...client.CallOption) (*common.Empty, error) {
...
func (c *dCService) UpdateNamespace(ctx context.Context, in *common.Namespace, opts ...client.CallOption) (*common.Empty, error) {
...
func (c *dCService) DeleteNamespace(ctx context.Context, in *common.Namespace, opts ...client.CallOption) (*common.Empty, error) {
...
func (c *dCService) InitDC(ctx context.Context, in *common.DataCenter, opts ...client.CallOption) (*common.Empty, error) {
...
func RegisterDCHandler(s server.Server, hdlr DCHandler, opts ...server.HandlerOption) error {
	type dC interface {
		...
		DeleteApp(ctx context.Context, in *common.AppDeployment, out *common.Empty) error
		CreateNamespace(ctx context.Context, in *common.Namespace, out *common.Empty) error
		UpdateNamespace(ctx context.Context, in *common.Namespace, out *common.Empty) error
		DeleteNamespace(ctx context.Context, in *common.Namespace, out *common.Empty) error
		InitDC(ctx context.Context, in *common.DataCenter, out *common.Empty) error
...
func (h *dCHandler) DeleteApp(ctx context.Context, in *common.AppDeployment, out *common.Empty) error {
	return h.DCHandler.DeleteApp(ctx, in, out)
}

func (h *dCHandler) CreateNamespace(ctx context.Context, in *common.Namespace, out *common.Empty) error {
	return h.DCHandler.CreateNamespace(ctx, in, out)
}

func (h *dCHandler) UpdateNamespace(ctx context.Context, in *common.Namespace, out *common.Empty) error {
	return h.DCHandler.UpdateNamespace(ctx, in, out)
}

func (h *dCHandler) DeleteNamespace(ctx context.Context, in *common.Namespace, out *common.Empty) error {
	return h.DCHandler.DeleteNamespace(ctx, in, out)
}

func (h *dCHandler) InitDC(ctx context.Context, in *common.DataCenter, out *common.Empty) error {
