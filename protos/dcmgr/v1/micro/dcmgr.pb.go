...
func (*DataCenterListResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_dcmgr_b8344e2d7552f837, []int{0}
}
...
func (*NetworkInfoResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_dcmgr_b8344e2d7552f837, []int{1}
}
...
func (*DataCenterLeaderBoardResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_dcmgr_b8344e2d7552f837, []int{2}
}
...
func (*DataCenterLeaderBoardDetail) Descriptor() ([]byte, []int) {
	return fileDescriptor_dcmgr_b8344e2d7552f837, []int{3}
}
...
func init() { proto.RegisterFile("dcmgr/v1/micro/dcmgr.proto", fileDescriptor_dcmgr_b8344e2d7552f837) }

var fileDescriptor_dcmgr_b8344e2d7552f837 = []byte{
