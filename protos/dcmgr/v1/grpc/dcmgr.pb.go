...
func (*DataCenterListResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_dcmgr_83b2614b32144e2a, []int{0}
}
...
type DCStreamer_ServerStreamClient interface {
	Send(*common.DCRequest) error
	Recv() (*common.DCResponse, error)
	grpc.ClientStream
}
...
func (x *dCStreamerServerStreamClient) Send(m *common.DCRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *dCStreamerServerStreamClient) Recv() (*common.DCResponse, error) {
	m := new(common.DCResponse)
...
type DCStreamer_ServerStreamServer interface {
	Send(*common.DCResponse) error
	Recv() (*common.DCRequest, error)
	grpc.ServerStream
}
...
func (x *dCStreamerServerStreamServer) Send(m *common.DCResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *dCStreamerServerStreamServer) Recv() (*common.DCRequest, error) {
	m := new(common.DCRequest)
...
func init() { proto.RegisterFile("dcmgr/v1/grpc/dcmgr.proto", fileDescriptor_dcmgr_83b2614b32144e2a) }

var fileDescriptor_dcmgr_83b2614b32144e2a = []byte{
	...
	0x43, 0xe8, 0x0a, 0x82, 0xaa, 0x33, 0x0a, 0xe5, 0xe2, 0x72, 0x71, 0x0e, 0x2e, 0x29, 0x4a, 0x4d,
	0xcc, 0x4d, 0x2d, 0x12, 0x72, 0xe7, 0xe2, 0x09, 0x4e, 0x2d, 0x2a, 0x4b, 0x2d, 0x82, 0x88, 0x08,
	0x89, 0xa3, 0xe9, 0x77, 0x0e, 0x4a, 0x2d, 0x2c, 0x4d, 0x2d, 0x2e, 0x91, 0x92, 0xc0, 0x94, 0x80,
	0x38, 0x41, 0x89, 0x41, 0x83, 0xd1, 0x80, 0xd1, 0xc8, 0x9f, 0x8b, 0xd5, 0xc5, 0xd9, 0x31, 0xc0,
	0x53, 0xc8, 0x8d, 0x8b, 0x0f, 0xd5, 0xad, 0x42, 0xc2, 0xa8, 0x5a, 0x5d, 0x73, 0x0b, 0x4a, 0x2a,
	0xa5, 0x64, 0xf5, 0x20, 0x9e, 0xc7, 0xee, 0x2f, 0x25, 0x86, 0x24, 0x36, 0xb0, 0x6a, 0x63, 0x40,
	0x00, 0x00, 0x00, 0xff, 0xff, 0x00, 0xa4, 0x9f, 0x04, 0x33, 0x01, 0x00, 0x00,
}
