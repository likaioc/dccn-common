...
func (c *dCStreamerClient) ServerStream(ctx context.Context, opts ...grpc.CallOption) (DCStreamer_ServerStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &_DCStreamer_serviceDesc.Streams[0], "/grpc.dcmgr.DCStreamer/ServerStream", opts...)
	if err != nil {
		return nil, err
	}
...
var _DCStreamer_serviceDesc = grpc.ServiceDesc{
	ServiceName: "grpc.dcmgr.DCStreamer",
...
func init() { proto.RegisterFile("dcmgr/v1/grpc/dcmgr.proto", fileDescriptor_dcmgr_dca06ac464374f59) }

var fileDescriptor_dcmgr_dca06ac464374f59 = []byte{
	...
	0x4b, 0xf2, 0x85, 0xb8, 0x40, 0x22, 0x7a, 0x60, 0x11, 0x29, 0xa1, 0xe4, 0xfc, 0xdc, 0xdc, 0xfc,
	0x3c, 0xfd, 0xd4, 0xb2, 0xd4, 0xbc, 0x12, 0x88, 0xbc, 0x91, 0x0f, 0x17, 0x97, 0x8b, 0x73, 0x70,
	0x49, 0x51, 0x6a, 0x62, 0x6e, 0x6a, 0x91, 0x90, 0x1d, 0x17, 0x4f, 0x70, 0x6a, 0x51, 0x59, 0x6a,
	0x11, 0x44, 0x44, 0x48, 0x58, 0x0f, 0xa2, 0x05, 0xa2, 0x58, 0xcf, 0x15, 0xa4, 0x51, 0x0a, 0x9b,
	0xa0, 0x12, 0x83, 0x06, 0xa3, 0x01, 0x63, 0x12, 0x1b, 0x58, 0xc8, 0x18, 0x10, 0x00, 0x00, 0xff,
	0xff, 0x78, 0xb9, 0xa0, 0xe5, 0x91, 0x00, 0x00, 0x00,
}
