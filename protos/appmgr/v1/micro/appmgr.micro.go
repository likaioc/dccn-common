...
type AppMgrService interface {
	...
	SaveChart(ctx context.Context, in *SaveChartRequest, opts ...client.CallOption) (*common.Empty, error)
...
func (c *appMgrService) SaveChart(ctx context.Context, in *SaveChartRequest, opts ...client.CallOption) (*common.Empty, error) {
...
func RegisterAppMgrHandler(s server.Server, hdlr AppMgrHandler, opts ...server.HandlerOption) error {
	type appMgr interface {
		...
		SaveChart(ctx context.Context, in *SaveChartRequest, out *common.Empty) error
...
func (h *appMgrHandler) SaveChart(ctx context.Context, in *SaveChartRequest, out *common.Empty) error {
